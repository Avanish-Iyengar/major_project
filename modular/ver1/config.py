...
GEMINI_API_KEY = "AIzaSyDAC4KpflXfg5-pR8J8c3yjm9jkHDoJ7ss"      # aistudio.google.com → Get API Key
...
DETECTION_SCALE = 0.5     # MediaPipe runs at this fraction of full resolution.
                          # 0.5 = 2–3× faster. Raise toward 1.0 if joints drift.

# ── 4. Smoothing ──────────────────────────────────────────────────────────────
EMA_ALPHA         = 0.4   # Landmark smoothing. Lower = smoother, more lag.
