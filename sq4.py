...
LM = {
    ...
    "left_elbow":     13, "right_elbow":    14,   # ← NEW
    "left_wrist":     15, "right_wrist":    16,   # ← NEW
...
SKELETON_CONNECTIONS = [
    ...
    ("left_shoulder",  "left_elbow"),      # ← NEW
    ("right_shoulder", "right_elbow"),     # ← NEW
    ("left_elbow",     "left_wrist"),      # ← NEW
    ("right_elbow",    "right_wrist"),     # ← NEW
